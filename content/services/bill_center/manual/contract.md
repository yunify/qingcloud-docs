...
当您想要对青云QingCloud 订购的产品进行报销等操作时，可以申请开具合同。申请合同中填写的公司（或个人）视为实际交易的法律主体。
...
5. 点击**立即转为正式合同**，弹出**转为正式合同**窗口。
   ...
   若页面弹出提示信息**转为正式并申请纸质合同成功**，则说明转为正式合同成功。

   转为正式合同后，无法作废。电子合同生效，具有法律效力，可直接使用。青云QingCloud 也将根据您预留的通讯地址将纸质合同邮寄给您。
...
> **说明：**
>
> 合同草稿转为正式合同后，青云QingCloud 会根据您预留的通讯地址尽快将纸质合同邮寄给您。
