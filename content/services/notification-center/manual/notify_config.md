...
![message_config](../../_images/message_config.png)
...
4. 配置消息接收方式。
   ...
   **添加接收人**
   ...
   ![message_config_1](../../_images/message_config_1.png)

   2. 勾选需要添加的接收人，点击“确定”。

   ![message_config_2](../../_images/message_config_2.png)
   ...
   **移除接收人**
   ...
   ![message_config_3](../../_images/message_config_3.png)

   2. 至少选择一个接收人，点击**确定**。

   ![message_config_4](../../_images/message_config_4.png)
