...
keyword: 云计算,大数据,ZooKeeper,手动续费,自动续费
weight: 60
collapsible: false
draft: false
---
...
5. 展开下拉菜单，点击**设置自动续约**，弹出自动续费配置窗口。
   ...
   <img src="/bigdata/zookeeper/_images/renewal_auto.png" alt="手动续费" style="zoom:50%;" />
...
5. 展开下拉菜单，点击**手动续费**，弹出手动续费窗口。
   ...
   <img src="/bigdata/zookeeper/_images/renewal_manual.png" alt="手动续费" style="zoom:50%;" />
