...
|   描述  |  （可选）对集群的简要描述。   |
|   版本 |  选择集群版本。| 
|   资源配置类型 |  选择集群节点云服务器规格。<li>可选择`1核2G`、`2核4G`、`4核8G`、`8核16G`、`16核32G`。<li>选择**自定义**，需自定义集群各节点云服务器规格。<li>`HBase 1.2.6 - v1.1.0` 版本默认需自定义各节点规格。| 
...
|   主机类型  |  选择集群云服务器类型。<li>当版本为 `HBase 2.0.6 - v2.1.0` 时，主机类型默认为`基础型`。|
