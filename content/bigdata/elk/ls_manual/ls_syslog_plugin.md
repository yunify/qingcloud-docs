...
> **说明**
>
> 更多的预置 Logstash 插件请参见 [Logstash 预置插件列表](../ls_plugins)。
...
1. 在集群详情页面，切换到参数配置页面，选择 Logstash 节点，修改`input_conf_content`配置项为如下，点击保存。
   ...
   >
   > 请根据您的具体配置替换上面的配置，其他配置参数详情请参见[官方文档](https://www.elastic.co/guide/en/logstash/master/plugins-inputs-syslog.html)。
