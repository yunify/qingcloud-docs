---
title: "新增 Redis 数据源"
description: 本小节主要介绍如何新增 Redis 数据源。 
keywords: 
weight: 70
collapsible: false
draft: false
...
数据源是大数据工作台用于数据处理的出入口。本小节主要介绍如何新增 Redis 数据源。
...
6. 选择 **Redis** 数据源类型，进入配置数据源页面。
   ...
   2. 配置数据源连接信息。
      ...
      | 密码（Password）       | Redis 服务访问密码。                                | 

      <img src="/bigdata/dataomnis/_images/source_data_set_redis_connect.png" alt="配置 Redis 数据源连接信息" style="zoom:50%;" />
