...
6. 选择 **ElasticSearch** 数据源类型，进入配置数据源页面。
   ...
   2. 配置数据源连接信息。
      ...
      | <span style="display:inline-block;width:140px">参数</span>  | <span style="display:inline-block;width:520px">参数说明</span>  |
      | :--------- | -------------------------------------------- |
      | 连接地址    | 格式为 ip:port。端口号默认为 `9200`。 |   
      | 版本    | Elasticsearch 的版本。 |         
      ...
      <img src="/bigdata/dataomnis/_images/source_data_set_elasticsearch_connect.png" alt="配置 Elasticsearch 数据源连接信息" style="zoom:50%;" />
