...
<img src="/bigdata/dataomnis/_images/cfg_source_postgresql_01.png" alt="可视化方式" style="zoom:50%;" />

**表达式方式**

条件参数配置默认使用可视化方式，您可以根据使用习惯切换为表达式方式。

<img src="/bigdata/dataomnis/_images/cfg_source_postgresql_02.png" alt="表达式方式" style="zoom:50%;" />