...
1. 在作业开发面板右侧点击**环境参数**，进入运行参数配置页面。 
2. 选择计算集群、配置作业并行度，以及选择依赖资源。详细信息请参见[配置环境参数](../enviroment)。   
3. 设点击**确定**，完成环境参数配置。

## 发布作业

完成作业调度和环境参数配置后，您才可以发布作业。

1. 点击**发布**，弹出发布调度任务对话框。

   <img src="/bigdata/databench/_images/publish_job.png" alt="发布作业" style="zoom:50%;" />
