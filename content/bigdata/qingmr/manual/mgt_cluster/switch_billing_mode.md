...
keyword: 云计算,大数据,QingMR,QingMR 集群切换计费模式
weight: 40
collapsible: false
draft: false
---
...
> **说明**
> 
> 当前计费模式为**包年包月**的集群，不支持直接修改计费模式。您可以通过[退订](/bigdata/qingmr/manual/mgt_cluster/unsubscribe)操作，将包年包月集群切换为按小时计费集群。

## 前提条件

- 已获取管理控制台登录账号和密码，且已获取集群操作权限。
- 请您确保余额充足，以免扣费对其他资源造成影响。
- QingMR 集群**计费模式**为`按小时计费`。
