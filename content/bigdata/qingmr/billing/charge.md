...
按需计费的集群没有到期的概念。    
包年/包月的集群是预付费，QingMR 集群的续费方式默认为`到期不续费`，到期后集群资源会自动变更为按需计费模式。  

> **注意**
> 
> 按需计费相比包年/包月单价更高，建议您留意系统通知，并及时切换计费模式。

## 欠费说明

包年/包月的集群没有到期的概念。   
按需计费的集群按小时付费，如果您的余额不足，无法对上一个小时产生的费用进行扣费，就会导致集群欠费，资源会被自动暂停，并保留 5 天时间，在此期间内您可以随时充值来恢复资源。

> **注意**
> 
> 若欠费逾期仍未充值，资源会被删除，删除的资源会在“回收站”保留 2 小时，之后便会被彻底删除，无法再恢复。请您留意系统通知，并及时充值，以免造成损失。
