...
点击**创建集群**，填写集群相关参数，详细信息请参见[创建集群](bigdata/dataplat/manual/data_development/cluster/add_cluster/)。
...
点击操作列的**修改**，进入修改计算集群页面，集群相关参数请参见[创建集群集群](bigdata/dataplat/manual/data_development/cluster/add_cluster/)。

## 停用计算集群

点击操作列的![](../../../../_images/icon_more_cluster.png)图标，选择**停用**，在停用计算集群对话框中确认注意事项后，单击**停用**。
...
点击操作列的![](../../../../_images/icon_more_cluster.png)图标，选择**删除**，在删除计算集群对话框中确认注意事项后，单击**删除**。
