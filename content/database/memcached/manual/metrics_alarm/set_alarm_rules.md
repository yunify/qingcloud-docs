---
title: "设置监控告警"
description: 本小节主要介绍如何设置 Memcached 监控告警。 
keyword: 设置告警,监控告警,Memcached,键值数据库
weight: 20
collapsible: false
draft: false
---
...
- 支持[绑定指标告警策略](#绑定指标告警策略)，自定义告警规则和监控项，及时监控 Memcached 各项指标状态。  
    
    - 可自定义监控项：`CPU利用率`、`内存使用率`、`磁盘使用量`、`节点服务状态`、`过期的 Key 个数`  
    - 可自定义监控周期：`1分钟`、`5分钟`
