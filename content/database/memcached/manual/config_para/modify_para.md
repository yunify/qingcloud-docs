---
title: "修改配置参数"
description: 本小节主要介绍如何修改 Memcached 配置参数。 
keyword: 修改参数,修改配置,Memcached,键值数据库
weight: 15
collapsible: false
draft: false
---
...
在 AppCenter 集群管理控制台，支持修改 Memcached 集群的配置参数。

> **注意**
> 
> 各参数的值设置需根据云服务器、存储磁盘配置情况，以及数据库其他参数情况进行调整。

本小节主要介绍如何修改 Memcached 集群的配置参数。
...
> **说明**
> 
> 当配置参数值发生变化时，将会重启对应的 Memcached 服务。
