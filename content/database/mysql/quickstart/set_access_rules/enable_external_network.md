...
- **外网**又叫公网。开启外网访问后，外网地址可能会降低集群的安全性，请谨慎使用。
   ...
   - 外网地址及其使用的公网 IP，目前免费使用，由系统后台统一维护。
...
3. 在弹出的外网申请须知窗口，确认申请须知和免责声明信息后，勾选**已阅读申请须知和免责声明，并同意申请外网地址**。
...
3. 弹出外网访问白名单配置窗口，根据白名单配置要求，输入允许访问的外网服务器 IP。
...
5. 在**连接信息**模块，即可查看已配置的外网访问地址和 IP 白名单。
