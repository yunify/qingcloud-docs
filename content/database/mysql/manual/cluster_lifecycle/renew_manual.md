...
为避免集群到期未续费而造成集群无法使用或其他损失，您可以提前为**包年包月**的集群进行续费。
...
5. 展开下拉菜单，点击**设置自动续费**，弹出自动续费配置窗口。
   ...
   <img src="../../../_images/auto_renew_manual.png" alt="手动续费" style="zoom:100%;" />
...
MySQL Plus 集群计费模式为包年包月，您可以手动续费集群使用配额。
...
5. 展开下拉菜单，点击**手动续费**，弹出手动续费窗口。
   ...
   <img src="../../../_images/renew_manual.png" alt="手动续费" style="zoom:100%;" />
