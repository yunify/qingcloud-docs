---
title: "查看资源和服务监控"
description: 本小节主要介绍如何查看 MongoDB 监控。 
keyword: 监控指标,查看监控,监控视图,MongoDB,文档数据库,数据库
weight: 40
collapsible: false
draft: false
---
...
云监控 CloudSat 可对 MongoDB 的运行状态进行日常监控。您可以通过 CloudSat 管理控制台，一站式监控和告警 MongoDB 各类服务、资源指标。您可以在 MongoDB 集群详情页面，查看主实例监控和查看备实例监控。
...
- 已创建 MongoDB 集群，集群状态为**活跃**，且服务状态为**正常**。 
