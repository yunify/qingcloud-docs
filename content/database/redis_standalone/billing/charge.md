---
title: "到期与欠费"
description: 本小节主要介绍 Redis Standalone 到期与欠费说明。 
keyword: 到期,欠费,数据库,键值数据库,Redis Standalone 
weight: 30
collapsible: false
draft: false
---
...
**包年/包月**的 Redis Standalone 集群续费方式默认为`到期不续费`，即到期后集群不会自动续费。若到期未续费，集群资源会自动变更为按需计费模式。  

> **注意**
> 
> 按需计费相比包年/包月单价更高，建议您提前对集群进行续费。
<!--Redis Standalone 集群目前支持手动续费，详细操作请参见[续费集群](../../manual/cluster_lifecycle/renew_manual)。-->
