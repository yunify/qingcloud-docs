...
| 控制台管理 ACL     |  <li>是  <li>否     | 表示是否由控制台管理 ACL 服务。<br>- 默认为 `是`，表示开启控制台管理 ACL 服务，禁止通过命令创建 ACL 帐号。 <br>- `否`表示关闭控制台管理 ACL 服务，支持通过命令创建 ACL 帐号。<div style="background-color: #D8ECDE; padding: 10px 24px; margin: 10px 0; border-left: 3px solid #00a971;">  <b>⚠️注意</b><br/>  再次开启此服务，将删除已存在的 ACL 用户。</div>      | **✕**       | **✓**     |
...
| io-threads | - | IO 多线程。默认值为：<br/><ul><li>单线程：1</li><li>多线程：7</li></ul> | **✕** | **✓** |
| io-threads-do-reads | <ul><li>no</li><li>yes</li></ul> | IO 开启多线程读。默认值为：<br/><ul><li>单线程：no</li><li>多线程：yes</li></ul> | **✕** | **✓** |
