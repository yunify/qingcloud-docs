...
通知策略是：分别在提前30, 15，7，3，2，1 天时发送提醒。 默认是发送给账号的注册手机号及通知邮箱，如果用户希望自定义接受者列表，可在 [账户信息](https://console.qingcloud.com/account/profile/notify_map/) 中修改“财务通知”对应的通知列表。
...
针对用户长期、稳定的 IT 需求，青云 QingCloud 全新推出『预留合约』计费模式， 目前此模式仅适用于主机、专属宿主机 (详情参看 [_专属宿主机_](dedicated_host.html#guide-dedicated-host) )，和硬盘，相对于弹性付费可享有更优惠价格。
...
>注解
以主机为例，专属宿主主机和硬盘在申请，支付，续费，升级，取消，终止，绑定资源上类似。
