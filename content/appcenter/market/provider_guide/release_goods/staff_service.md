...
人工服务类商品是指由服务商提供的人工服务，主要提供如服务器运维、环境配置、数据迁移、故排查、授权软件安装等服务。
...
2. 在左侧导航栏，选择**商品** > **商品管理**，然后点击**发布商品**。
   ...
   ![](../../../_images/publish_staff_service.png)
...
6. 点击**下一步：销售信息**，配置商品销售信息。
   ...
   | 参数         | 说明                                                         |
   | ------------ | ------------------------------------------------------------ |
   | 前台是否可见 | 默认为**是**，表示商品上架后会在云市场前台公开进行售卖。若选择**否**，则该商品上架后不会在云市场前台公开对外售卖，只能通过商品 URL 进行访问或购买。 |
