...
- 应用本身服务调用的日志     
  ...
  ![faq_applog.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_applog.png)

- 监控日志
  监控日志主要是指用户开发的健康检查和监控命令调用的日志。   
  在 [AppCenter 应用开发平台](https://appcenter.qingcloud.com/developer/) 上可以查到相关日志。  
  ![faq_applog.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_appmonitorlog.png)
...
![faq_healthcheck.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_healthcheck.png)
...
![faq_monitor.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_monitor.png)
...
如果配置了此参数，在控制台上会展示各个节点的具体监控数据的值。   
![faq_customservice.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_customservice.png)
...
![faq_params.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_params.png)
...
![faq_pattern.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_pattern.png)
...
![faq_nodedetails.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_nodedetails.png)
...
![faq_vnc.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_vnc.png)    
同时，在[AppCenter应用开发](https://appcenter.qingcloud.com/apps/)搜索找到你需要的应用，打开`资源`tab页，右侧有一个VNC小图标。    
![faq_vnc2.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_vnc2.png)   
...
backup_policy
定义应用的备份策略，支持 "device" 和 "custom" 两种类型。
"device" 表示对节点的挂盘做snapshot；"custom" 则是使用自定义的备份命令进行备份操作，比如备份到某个目录，或拷贝到某个节点。非必填项
...
![faq_backup.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_backup.png)
...
![faq_vip.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_vip.png)
...
因此建议大家在编写脚本的时候重新再export一下环境变量，或者source一下环境变量的文件。    
例如export PGDATA=/data/pgsql/main  或者 source /etc/profile
...
![faq_depend.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_depend.png)
...
![err_code.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/err_code.png)
...
![faq_scale.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_scale.png)
...
![faq_vxnet.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_vxnet.png)
...
![faq_appid.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/faq_appid.png)
...
- 参考 [管理纯主机集群样例](agent-no-install.html) 
...
![s3_type_none.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/s3_type_none.png)

当 s3_type 值为 minio 时，s3_access_key 和 s3_secret_key 显示，access_key 不显示
![s3_type_minio.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/s3_type_minio.png)

当 s3_type 值为 QingStor 时，access_key 显示，s3_access_key 和 s3_secret_key 都不显示
![s3_type_qingstor.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/s3_type_qingstor.png)

## 36. 如何定义in-place升级方式？

* cluster.json.mustache 的 upgrading_policy 定义为 in-place，同时定义 in-place-upgrade-nodes 信息：

```json
{
  "upgrading_policy": "in-place",
...
| 参数                   | -         | -             | 描述                                                         |
| ---------------------- | --------- | ------------- | ------------------------------------------------------------ |
| upgrading_policy       | -         | -             | 定义版本升级的模式，支持parallel、sequential 和 in-place     |
| in-place-upgrade-nodes | -         | -             | in-place 升级时，需要使用的备份以及拷贝操作信息，定义在里面。 |
| -                      | container | -             | 备份信息，必填项。                                           |
| -                      | -         | snapshot      | 备份 ID。                                                    |
| -                      | -         | zone          | 备份制作时所属区域。                                         |
| -                      | copy      | -             | 定义由备份恢复的硬盘，in-place 升级时拷贝操作相关信息。      |
...
![notice_when_upgrade.png](C:/Users/qing/qingcloud/qingcloud-docs/content/images/notice_when_upgrade.png)
...
其中 event 的可选值为：upgrade, scale_vertical。表示在定义的生命周期到来时，使用 get_nodes_order 中 cmd 的执行结果作为该生命周期节点的操作顺序。
