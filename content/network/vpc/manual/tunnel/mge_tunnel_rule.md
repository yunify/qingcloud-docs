...
| IKE 版本            | 选择 IKE 协议的版本。<ul><li>IKEv2 Only：使用 IKEv2。 </li><li>IKEv1 Only：使用 IKEv1</li><li>自动匹配：系统自动匹配。</li></ul>相对于IKEv1版本，IKEv2 版本简化了 SA 的协商过程并且对于多网段的场景提供了更好的支持，也更加安全，建议选择 IKEv2 版本。 |
