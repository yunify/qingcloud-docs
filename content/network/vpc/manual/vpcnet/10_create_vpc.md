...
4. 配置 VPC 网络基本信息及初始私有网络信息。
   ...
   <table>
     ...
     <tr>
     	<td>IPv6 地址范围</td>
     	<td>选择是否为 VPC 网络分配 IPv6 网段。
         <ul>
         <li><b>关闭 IPv6</b>：默认选项，即不分配 IPv6 网段。</li>
         <li><b>系统自动分配</b>：开启 IPv6 功能，并自动分配 IPv6 网段。</li>
         </ul></td>
     </tr>
      <tr>
     	<td>类型</td>
    ...
    <tr>
     ...
     <tr>
     	...
     	<td>
         <ul>
         <li>多可用区部署：表示网络中的云服务器可部署在多个可用区。</li>
    ...
    <tr>
   	...
   	<tr>
     	<td>IPv6 地址范围</td>
     	<td>仅当所属 VPC 网络开启 IPv6 功能，其私有网络才支持开启 IPv6。
         <ul>
         <li><b>关闭 IPv6</b>：默认选项，即不分配 IPv6 网段。</li>
          <li><b>系统自动分配</b>：开启 IPv6 功能，并自动为子网分配 IPv6 网段。</li>  
         </ul>
