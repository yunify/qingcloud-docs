...
5. 点击**立即创建**，等待创建完成。
   ...
   <!--点击已创建好的 VPC，进入 VPC 详情页面。默认展示**私有网络**页签。-->

   <!--在**私有网络**页签区域，点击<img src="/network/vpc_2.0/_images/4020_vpc_add_vxnet_icon.png" alt="vpc_add_vxnet_icon" style="zoom:50%;" />，弹出**创建/连接私有网络**页面。-->
