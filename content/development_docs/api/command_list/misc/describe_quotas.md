...
| cpu | String | 主机 CPU 配额 |
| dedicated_host | String | 专属宿主机配额 |
| dedicated_host_group | String | 专属宿主机组配额 |
...
| hp_cpu | String | 超高性能型主机的 CPU 配额 |
| hp_dedicated_host | String | 超高性能型专属宿主机配额 |
| hp_dedicated_host_group | String | 超高性能型专属宿主机组配额 |
| hp_hadoop | String | 超高性能型 Hadoop 配额 |
| hp_hbase | String | 超高性能型 HBase 配额 |
| hp_hdw | String | 超高性能型 HDW 配额 |
| hp_instance | String | 超高性能型主机个数配额 |
| hp_memory | String | 超高性能型主机内存配额 |
