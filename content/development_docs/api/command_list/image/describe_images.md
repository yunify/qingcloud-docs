...
| tags | String | <ul><li>color：String 类型，标签颜色</li><li>tag_id：String 类型，标签 id</li><li>tag_value：String 类型，标签值</li><li>tag_name：String 类型，标签名</li><li>owner：String 类型，标签的所有者</li><li>tag_key：String 类型，标签键</li></ul> |
