...
*   要删除的防火墙已加载规则到路由器，则需要先调用 [_ModifyRouterAttributes_](/network/vpc/api/vpc_api/modify_router_attributes/) 并 [_UpdateRouters_](/network/vpc/api/vpc_api/update_routers/) 将其他防火墙的规则应用到对应路由器，之后才能被删除。
