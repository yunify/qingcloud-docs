...
针对用户长期、稳定的 IT 需求，青云 QingCloud 全新推出『预留资源』计费模式， 目前此模式仅适用于主机、专属宿主机，和关系型数据库，相对于按需付费可享有更优惠价格。
...
cloudsat目前未单独计费，计费通过使用时指定的外部基础资源使用情况计算费用。cloudsat相关服务使用时指定的外部资源即主机、硬盘、防火墙、公网 IP、 VPC 网络等资源费用。所有基础资源费用的计算周期以资源创建时间为起点，以资源销毁时间为终点。