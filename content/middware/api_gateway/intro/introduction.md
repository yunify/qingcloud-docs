...
API 网关（API Gateway）基于开源框架 Apache APISIX，提供 API 托管服务，包括 API 的创建、维护、发布、运行、下线等完整生命周期管理，帮助您快速构建以 API 为核心的系统架构，将自身的数据、业务逻辑或功能安全可靠的开放出来。通过 QingCloud AppCenter 平台，可将已创建的 API 服务通过 API 类应用的创建方式上架到 AppCenter 应用市场，从而提供给用户调用使用。
