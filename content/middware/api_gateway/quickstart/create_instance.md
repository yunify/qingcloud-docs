...
通过 AppCenter 集群管理控制台，您可以快速创建 API 网关专享实例。
...
5. 配置实例规格。
   ...
   QingCloud API 网关提供`基础版`、`专业版`、`企业版`、`企业高级版`四种专享实例规格。不同版本的最大请求数、SLA、最大连接数以及费用都不同，配置越高，费用越高。
...
6. 配置实例信息。
   ...
   **用户协议**：阅读**云平台 AppCenter 用户协议**，并勾选用户协议。
