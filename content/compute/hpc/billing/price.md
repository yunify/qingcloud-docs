...
青云EHPC集群平台提供多种配置的节点类型，用户根据实际需求选择对应的节点配置参数，支付相应的费用。不同配置参数的节点对应的收费标准如下表所示。

| 资源类型 | 产品配置                                                     | 配置（已关闭超线程）                                         | 适用的节点类型               | 包年包月（元/月） | 按需（元/小时） |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------------------------- | ----------------- | --------------- |
| 集群节点 | CPU 服务器配置2*6258R 2.7GHz 28C 192G应用登录、管控、计算节点 | 54核160G                                                     | 超级计算节点                 | 8114.020          | 17.322          |
|          |                                                              | 26核80G                                                      | 登录节点、管控节点、计算节点 | 4003.047          | 8.340           |
|          |                                                              | 12核40G                                                      | 登录节点、管控节点、计算节点 | 1847.560          | 3.849           |
|          |                                                              | 8核24G                                                       | 登录节点、管控节点、计算节点 | 1231.707          | 2.566           |
|          |                                                              | 4核12G                                                       | 登录节点、管控节点、计算节点 | 615.853           | 1.283           |
|          |                                                              | 2核4G                                                        | 登录节点、管控节点、计算节点 | 307.927           | 0.642           |
|          |                                                              | 1核2G                                                        | 登录节点、管控节点           | 153.963           | 0.321           |
|          | GPU 服务器配置2* 8358 2.6 32C 512G A100应用计算节点          | CPU 62核480G，GPU NIVDIA A100 * 8                            | GPU计算节点                  | 103694.400        | 184             |
|          |                                                              | CPU 32核240G，GPU NIVDIA A100 * 4                            | GPU计算节点                  | 51847.200         | 92              |
|          |                                                              | CPU 16核120G，GPU NIVDIA A100 * 2                            | GPU计算节点                  | 25923.600         | 46              |
|          |                                                              | CPU 8核60G，GPU NIVDIA A100 * 1                              | GPU计算节点                  | 12961.800         | 23              |
|          | 裸金属计算                                                   | 56核192G                                                     | 裸金属计算节点               | 8313.45           | 17.3185         |
| 共享存储 | 文件存储EPFS                                                 | 最低不低于20G，最高无上限。建议按需配置，按需扩容。          | 数据文件存储                 | /                 | 0.0018元/G/小时 |
| 网络     | 公网IP(同pek3)                                               | 参考公有云平台公网IP的报价规格：https://www.qingcloud.com/pricing#/EIP计费标准说明参考：https://docs.qingcloud.com/product/faq/#id23 |                              |                   |                 |
