...
3. 您可以查看集群相关状态。
   ...
   | 状态           | 状态说明                                                     |
   | -------------- | ------------------------------------------------------------ |
   | 等待中、创建中 | 集群创建期间的状态，正在构建集群的登录节点、管控节点、计算节点，进行调度器、域账号服务等程序的安装，无需用户干预，预计 5 ～ 8 分钟。 |
...
2. 选择**队列管理**，进入队列管理页面。
   ...
   ![](../../../_images/um_cluster_queue_info.png)
...
2. 选择**用户与权限组**，进入用户与权限组页面。

   ![](../../../_images/um_cluster_user_info.png)
