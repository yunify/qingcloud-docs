...
*   配置登录
    ...
    点击 putty 左边导航的 session，host name 中填写云服务器的 公网IP 地址，例如1.2.3.4。
...
*   在[QingCloud 管理控制台](https://console.qingcloud.com/login)的 **安全** > **SSH 密钥** 里创建 SSH 密钥，将这个密钥加载到云服务器上并下载私钥文件，例如 kp-12345678；
...
*   在[QingCloud 管理控制台](https://console.qingcloud.com/login)创建 SSH 密钥，将这个密钥加载到云服务器上并下载私钥文件，例如放置于 /path/to/kp-1234abcd ；
