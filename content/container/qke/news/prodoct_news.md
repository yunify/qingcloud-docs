...
product:
    - time: 2021-09-26
      ...
      content: 1.升级到 Kubernetes 1.20.6。<br>2.内置 KubeSphere v3.1.1。<br>3.增加了集群创建前的部分检查项，优化了部分创建问题，提升集群创建成功率。<br>4.同步QingCloud云硬盘更新，优先挂载容量型硬盘（vos）。<br>5.修复了一些bug，提升了集群稳定性。
