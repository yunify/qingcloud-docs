...
- **Volume（卷）** 
  ...
  所谓容器的 Volume，其实就是将一个宿主机上的目录，跟一个容器里的目录绑定挂载在一起。在k8s 中，卷的类型有很多，不同类型的卷的功能都不一样，具体可以参照 [Kubernetes 中文社区｜中文文档_Kubernetes Volume](http://docs.kubernetes.org.cn/429.html#i)。
