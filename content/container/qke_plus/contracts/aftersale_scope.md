...
- QKE 产品功能使用培训支持，包括但不限于 镜像构建、Kubernetes、KubeSphere的一对一人工使用指导。
...
| 使用的QingCloud 公有云平台提供的基础资源可用性保障（包括云服务器(含操作系统及内核)、网络、存储） | ✅                    | ✅                     | ✅            | N/A                                                          |
| 关联的由 QingCloud 官方提供的应用服务可用性保障（包括弹性伸缩、告警管理、IAM、ELK集群、Harbor集群） | ✅                    | ✅                     | ✅            | N/A                                                          |
| 控制台开放的滚动升级服务可用性保障                           | ✅                    | ✅                     | ✅            | N/A                                                          |
| 由官方提供的内置kubesphere的安装、版本升级                   | ❌                    | ✅                     | ✅            | N/A                                                          |
| 由官方提供的生内置kubesphere内置组件安装                     | ❌                    | ✅                     | ✅            | N/A                                                          |
| 基于KubeSphere 组件部署业务遇到的问题处理                    | ❌                    | ❌                     | ❌            | 支持，需要L2+KS联合支持                                      |
| 由官方提供的内置QKCP的安装、版本升级                         | ❌                    | ❌                     | ✅            | N/A，L2+qke团队支持                                          |
| 由官方提供的内置QKCP内置组件安装                             | ❌                    | ❌                     | ✅            | N/A，L2+qke团队支持                                          |
| 基于QKCP组件部署业务遇到的问题处理                           | ❌                    | ❌                     | ✅            | N/A，L2+KS联合支持                                           |
| 由官方提供的内置kubesphere升级为内置QKCP                     | ❌                    | ❌                     | ✅            | N/A，L2+qke团队支持                                          |
| KubeSphere 的使用，以及当前 QKE 版本中出现的KubeSphere的BUG修复 | ❌                    | ❌                     | ❌            | 支持，L2+KS联合支持                                          |
| 内置QKCP引起的集群服务及客户业务异常或不可用                 | ❌                    | ❌                     | ✅            | N/A，L2+KS联合支持                                           |
| 客户业务中使用到的 K8s 资源对象的异常恢复（非QKE集群组件或插件以及公有云基础服务、应用服务异常导致） | ❌                    | ❌                     | ❌            | 支持，L2支持                                                 |
| 被纳管的 Member 集群为非 QingCloud 公有云平台购买的容器引擎服务 | ❌                    | ❌                     | ❌            | 支持，L2+KS联合支持（不包括Member集群底层基础资源的支持维护） |
| 微服务改造咨询                                               | ❌                    | ❌                     | ❌            | 支持，KS支持                                                 |
| 集群迁移咨询                                                 | ❌                    | ❌                     | ❌            | 支持，L2+QKE+KS团队支持                                      |
| 产品功能使用培训支持（如镜像构建、Kubernetes、KubeSphere的一对一人工使用指导） | ❌                    | ❌                     | ❌            | 支持，L2支持                                                 |