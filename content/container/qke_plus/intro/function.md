...
| 集群升级                                                     | <ul><li>⽀持集群版本⼀键原地升级。</li><li>⽀持包括内核、Kubernetes 版本、Docker 等集群组件的版本升级。</li><li>⽀持 Kubesphere 版本原地升级。</li></ul> |
...
| 授权管理                                                     | ⽀持 IAM 授权和 Kubernetes RBAC 权限管理。                   |
...
| 存储卷及存储声明 | <ul><li>⽀持存储卷的全⽣命周期管理， 包括：创建、删除、扩缩容及 Snapshot 等操作。</li><li>⽀持持久化存储卷声明（PVC）挂接存储卷。</li><li>⽀持存储卷的动态创建和迁移。</li></ul> |
...
| 功能模块       | 功能点                                                       |
| -------------- | ------------------------------------------------------------ |
| 应用全生命周期 | <ul><li>⽀持多种类型应⽤从镜像、模版的创建。</li><li>⽀持环境变 、数据盘、⽇志等相关配置。</li><li>⽀持应⽤查看、更新、删除。</li><li>支持应⽤历史版本回滚、应⽤事件查看。</li><li>支持应⽤滚动升级、应⽤替换升级以及通过触发器重新部署应⽤。</ul> |
