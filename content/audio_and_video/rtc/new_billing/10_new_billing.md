...
**按日**结算时，若您的套餐包分钟数不足以扣除前一日的分钟数，超过套餐包的分钟数，将按照 **10 元/千分钟**的单价从您的余额中扣除相应的费用。

> 注意：
>
> 超过套餐包的分钟数系统不区分音频、高清等资源项，均按照**10 元/千分钟**的单价从余额中扣除相应费用。
...
若您购买的套餐包剩余分钟数不足以扣除上一个结算期的分钟数，系统将按照 **10 元/千分钟**的单价从您的余额中扣除相应的费用。若余额不足，则会导致实时音视频 RTC 服务欠费。若您不及时续费，系统将**暂停**您的实时音视频 RTC 服务。

当您缴清欠费，并续订了可用的资源后，服务将立即自动开启。
