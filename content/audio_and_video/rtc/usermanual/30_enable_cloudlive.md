...
7. 在**开启云录制**页面，配置云录制相关信息。
   ...
   <table class="table table-bordered table-striped table-condensed">
     <tr>
       ...
       <td>
         录制音视频的分辨率。分辨率会影响音视频的清晰度，分辨率低图像比较模糊，分辨率高图像更清晰。<br>您可以根据您的需要选择<b>高分辨率</b>或者<b>低分辨率</b>。
       </td>
     </tr>
     <tr>
       <td>
       ...
       <td>
         存储地址为青云的对象存储。<br />请先选择文件存储的区域，再选择在对象存储创建的 Bucket。<br />为了不影响您已有的对象存储业务，请点击<b>新建 Bucket</b>，为 RTC 创建新的桶。<br />录播文件的前缀默认为 <i>CloudRecordMedia/</i>，您也可以根据您的需要进行修改。
       </td>
     </tr>
         <tr>
       <td>
