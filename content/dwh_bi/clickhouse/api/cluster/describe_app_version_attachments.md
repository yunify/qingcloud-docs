...
keywords: ClickHouse 应用配置文件，获取应用配置文件
weight: 12
collapsible: false
draft: false
---
...
| attachment_ids.n | String | 应用的配置文件 ID。可以根据 [DescribeAppVersions](../describe_app_versions) 获得。 | Yes |
| version_id | String | 应用版本的 ID。 | Yes |
