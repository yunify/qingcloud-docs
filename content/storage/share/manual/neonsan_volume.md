...
3. 在名称框里填入名称，根据需要选择创建新备份链，点击**提交** 。

   ![完成NeonSAN备份链创建](/storage/share/manual/_images/create_NeonSAN_14.png)

   当看到状态显示为“可用”，表示备份已经创建成功。
...
2. 鼠标左键点击备份链右侧的 **...** ，可以选择对备份链的修改、创建硬盘、回滚和删除。
