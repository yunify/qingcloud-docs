...
![](/storage/disk/billing/_images/reserved_contract.png)
...
![](/storage/disk/billing/_images/reserved_resources.png)

绑定成功之后该实例将不再使用“按需计费”的模式，解绑成功之后则恢复“按需计费”。

另外，合约详情页面也支持直接创建相应配置的新实例（主机）并直接与合约绑定。

![](/storage/disk/billing/_images/create_reserved_resources.png)
