...
- 之前进行过**手动续费**
  ...
  <b>升级费用= [ ( （原到期月份-当前月份） * SD-WAN 每月接入带宽 / 原周期内自然月天数 ) * 原周期内实际未用天数 ] *（目标带宽 - 原带宽）+ [ SD-WAN 每月接入带宽 * （现到期月份 - 原到期月份）] * （目标带宽 - 原带宽）</b> 
...
- 若提升带宽之前已手动续费两个月，现到期时间为 11月 2日，手动续费已付，现提升带宽，升级费用计算方式如下：
  ...
  升级费用= [ ( （原到期月份-当前月份）* SD-WAN 每月接入带宽 / 原周期内自然月天数 ) * 原周期内实际未用天数 ] *（目标带宽 - 原带宽）+ [ SD-WAN 每月接入带宽 *（现到期月份 - 原到期月份）] *（目标带宽 - 原带宽）
