...
本文档主要介绍 SD-WAN 的到期与欠费说明。

## 到期说明

**包年/包月**的 SD-WAN 若在创建接入点时，勾选了`账号余额足够时，设备到期自动续费`，即到期后余额充足，自动续费。

若没有勾选`账号余额足够时，设备到期自动续费`，接入点设备将停止为您提供服务。

## 欠费说明

**按需计费**的接入点设备**以秒为单位计费，按小时计算**；带宽上限**按固定带宽**计费。如果您的余额不足，无法对接下来一个小时的费用进行扣费，就会导致接入点设备欠费，SD-WAN 服务不可用，在此期间内您可以随时充值来恢复服务。
