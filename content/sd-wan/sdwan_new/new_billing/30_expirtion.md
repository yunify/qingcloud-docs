...
- 若购买**包年包月**的光盒 2 号设备、实例和带宽时，没有勾选**自动续费**，则到期后不会自动续费。若到期未续费，则会导致接入点设备停止服务，SD-WAN（新版）服务不可用。在此期间您可以在**云市场买家中心**为光盒 2 号设备进行手动续费，在控制台为实例和带宽手动续费或设置自动续费。
...
> 若服务停止 10 天后仍未充值，资源会被彻底删除，无法再恢复。请您留意系统通知，并及时充值，以免造成损失。
