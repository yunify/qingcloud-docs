...
| ------------------------------------------------------------ | ------------------------------------------------------------ | -------------------------------------- |
| 包年包月                                                     | 预付费模式，按月或按年收费，且享有大幅的优惠折扣。目前光盒 2 号订阅服务、实例和带宽都支持包年包月。下单链接：<a href="https://marketplace.qingcloud.com/">https://marketplace.qingcloud.com/</a></a>。 | 适用于使用光盒 2 号订阅服务的用户。    |
